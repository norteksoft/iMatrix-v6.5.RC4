...
<div id="accordion" >
	<h3><a href="${mmsCtx}/module/menu-tree.htm" id="menu_manage"><s:text name="mms.menuManager"></s:text></a></h3>
	<div>
		<div class="demo" id="menu_manage_content" style="margin-top: 10px;"></div>
	</div>
	<h3><a href="${mmsCtx}/module/operation.htm" id="operation_manage"><s:text name="mms.genericManager"></s:text></a></h3>
	<div>
