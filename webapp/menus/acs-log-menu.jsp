...
<div id="log_accordion" class="basic">
	...
	<h3><a href="log-data.action" id="_system_log"><s:text name="log.systemLog"/></a></h3><!-- 系统日志 -->
	<div>
		<ul class="ztree" id="auth_role_tree"></ul>
	</div>
	</security:authorize>
	<security:authorize ifAnyGranted="userLoginLog">
	<h3><a href="log-lookUserLoginLog.action" id="_login_log"><s:text name="log.loginLog"/></a></h3><!-- 登录日志 -->
	<div> 
	</div>
	</security:authorize>
