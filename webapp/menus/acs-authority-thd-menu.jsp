...
<div id="accordion" >
	<h3><a href="fast-permission-data.htm" id="permission-manager"><s:text name="menu.rapidAuthorization"/></a></h3><!-- 快速授权 -->
	<div>
		<ul class="ztree" id="fast_permission_content"></ul>
	</div>
	<h3><a href="permission-data.htm" id="permission-manager"><s:text name="menu.authorizationofthedata"/></a></h3><!-- 数据授权 -->
	<div>
		<ul class="ztree" id="permission-manager_content"></ul>
	</div>
		
	<h3><a href="data-rule.htm" id="data-rule-manager"><s:text name="menu.dataclassification"/></a></h3><!-- 数据分类 -->
	<div>
