...
<div id="accordion" >
	<h3><a href="list-data.htm" id="form-manager"><s:text name="mms.formManager"></s:text></a></h3>
	<div>
		<ul class="ztree" id="form_manage_content"></ul>
	</div>
	<h3><a href="list-view.htm" id="list-manager"><s:text name="mms.listManager"></s:text></a></h3>
	<div>
		<ul class="ztree" id="list_manage_content"></ul>
	</div>
	<h3><a href="data-table.htm" id="datatable-manager"><s:text name="mms.dataTableManager"></s:text></a></h3>
	<div>
