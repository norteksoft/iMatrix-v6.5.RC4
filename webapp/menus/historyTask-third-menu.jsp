...
<div id="accordion" >
	<h3><a href="${taskCtx}/task/history-workflow-task.htm?taskCategory=complete" id="historyTask-thirdMenu1"><s:text name="task.menu.completedMatters"></s:text></a></h3>
	<div>
		<ul class="ztree" id="completed_tree_id"></ul>
	</div>
	
	<h3><a href="${taskCtx}/task/history-workflow-task-canceled.htm?taskCategory=cancel" id="historyTask-thirdMenu2"><s:text name="task.menu.hasBeenCanceled"></s:text></a></h3>
	<div>
