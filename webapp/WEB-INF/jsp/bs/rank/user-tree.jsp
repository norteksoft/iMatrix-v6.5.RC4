	...
	function selectUsers(){
		ztree.selectTreeValue(function(){
			...
			if(names=='所有人员'||names=='所有部门'){
				iMatrix.alert("<s:text name='rankSelectDeptError'/>");
				return;
			}
			if(ids&&ids!=""){
...
<body style="padding: 5px;">
	...
	<form id="defaultForm" name="defaultForm"></form>
		...
		<div id="tabs" >
			<ul>
				<li><a href="#tabs-1" onclick="pageUlChange('a');"><s:text name="rankSelectUser"/></a></li>
				<li><a href="#tabs-1" onclick="pageUlChange('b')"><s:text name="rankSelectDept"/></a></li>
			</ul>
			<div id="tabs-1">
				<div class="opt-btn">
					<button class="btn" onclick="selectUsers();"><span><span><s:text name="basicSetting.confirm"></s:text></span></span></button>
				</div>
