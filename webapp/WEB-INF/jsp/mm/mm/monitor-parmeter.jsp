...
<body>
	...
	<aa:zone name="form_main">
			<div class="opt-body">
				<div class="opt-btn">
					<a   href="#" class='btn' onclick="ajaxAnyWhereSubmit('defaultForm','${mmCtx}/mm/monitor-parmeter-input.htm','form_main');"><span><span><s:text name="mm.add"/></span></span></a>
					<a   href="#" class='btn' onclick="updateParameter();"><span><span><s:text name="mm.update"/> </span></span></a>
				</div>
				<div id="opt-content" >
