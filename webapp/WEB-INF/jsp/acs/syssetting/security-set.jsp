		...
		<aa:zone name="acs_content">
			...
			<div id="opt-content">
				<form id="inputForm" name="inputForm" action="${acsCtx}/syssetting/security-set-save.action" method="post">
				    ...
				    <tr>
		             <td style="width: 170px;">
		                 <s:text name="securitSet.passwordExpirationAheadOf"/>
		             </td>
		             <td >
		                 ...
		                 (<s:text name="securitSet.day"/>)<s:text name="securitSet.passwordExpirationAheadOf.notice"/>
		                 <span style="color: red;"><s:text name="securitSet.passwordExpirationAheadOf.note"></s:text></span>
		             </td>
			        </tr>
			        <tr>  
		             <td style="width: 170px;">
