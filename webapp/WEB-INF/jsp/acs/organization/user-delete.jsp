      ...
      function loadTreeContent(type, id){
    	...
    	//ajax提交方法
    		...
    		if(ids==''){
    			...
    			return;
		      	...
		      	iMatrix.confirm({
		      		...
		      		confirmCallback:deleteUserOk,
		      		parameters:ids
		      	});
    		}
      	}
      	function deleteUserOk(ids){
      	...
      	function Dtree(){
			...
			if(uIds==''){
				 $("#notice").html("<span>"+iMatrixMessage["user.seleteUser"]+"</span>");
				 $("#notice").children("span").fadeOut(5000);
				 return;
			}else{
				$.colorbox({href:'${acsCtx}/organization/user-toDepartmentToUsersDel.action?ids='+uIds,iframe:true, innerWidth:600, innerHeight:500,overlayClose:false,title:iMatrixMessage["acs.pleaseSelectDepartment.colorboxTitle"]});
			}
		}
