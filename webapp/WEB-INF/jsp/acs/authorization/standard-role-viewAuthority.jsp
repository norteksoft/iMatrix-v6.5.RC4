...
<div class="ui-layout-center">
	<div class="opt-body">
		<div class="cbox-btn">
			...
			<span style="padding-top: 20px;"><s:text name="permission.item.type.role"/>：${entity.name }</span>
		</div>
		<div id="opt-content" style="height: 390px;width:726px; overflow: auto;">
							...
							<table class="TableBlock" align="center" style="">
								<tbody>
									<tr class="TableHeader" >
										<td><label ><b><s:text name="role.resourceName"/></b></label></td><!-- 资源名称 -->
										<td><label ><b><s:text name="role.resourceCode"/></b></label></td><!-- 资源编号 -->
										<td><label ><b><s:text name="role.resourcePath"/></b></label></td><!-- 资源路径 -->
									</tr>
