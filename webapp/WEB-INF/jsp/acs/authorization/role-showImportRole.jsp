...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<script type="text/javascript">
		function submitbutt(){
			if($("#filename").val()==''){
				iMatrix.alert(iMatrixMessage["menuManager.importValidate"]);
				return;
			}
		...
		function refereshParentPage(){
			...
			window.parent.jQuery("#main_table").trigger("reloadGrid"); 
	...
	<div class="opt-body">
		<div class="opt-btn">
			<button class="btn" onclick="submitbutt();"><span><span><s:text name="common.sure"/></span></span></button>
		</div>
		<div id="opt-content">
			...
			<form id="importForm" name="importForm" action="${acsCtx}/authorization/role-importRole.action" method="post" enctype="multipart/form-data">
