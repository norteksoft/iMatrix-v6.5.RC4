...
<div class="ui-layout-center">
	<aa:zone name="main_zone">
		<aa:zone name="btnZone">
			<div class="opt-btn">
				<button class="btn" onclick="submitStandardColumn();"><span><span ><s:text name="menuManager.confirm"></s:text></span></span></button>
			</div>
		</aa:zone>
		<div id="opt-content">
			<aa:zone name="viewZone">
				...
				<form action="" name="pageForm" id="pageForm" method="post">
					<table class="form-table-border-left" style="width: 150px;margin-left: 5px;margin-top: 5px;">
						...
						<s:if test="hasBranch">
							<tr>
								<td style="width: 25%;"><input name="fieldName" type="radio" value="~~subCompanyId" title="<s:text name="data.rule.standard.field.subCompany"></s:text>"/></td>
								<td><s:text name="data.rule.standard.field.subCompany"></s:text></td>
							</tr>
						</s:if>
					</table>
				</form>
