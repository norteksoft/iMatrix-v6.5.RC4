			...
			<div id="opt-content">
				...
				<form action="" name="viewSaveForm" id="viewSaveForm" method="post">
					...
					<table class="form-table-without-border">
						...
						<tr>
							<td class="content-title" style="width:100px"><s:text name="permission.describe"/><!-- 描&nbsp;&nbsp;&nbsp;&nbsp;述 -->：</td>
						...
						-->
						<tr>
							<td class="content-title"><s:text name="permission.people"/><!-- 人&nbsp;&nbsp;&nbsp;&nbsp;员 -->：</td>
							<td>
								<input type="radio" name="allUser" value="true" <s:if test="allUser">checked=checked</s:if> onclick="settingUserType();" id="allUser"></input><s:text name="permission.item.type.all.user"/><!-- 所有人 -->&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="allUser" value="false" <s:if test="!allUser">checked=checked</s:if> onclick="settingUserType();" id="userSet"></input><s:text name="permission.setPerson"/><!-- 设置人员 -->
							</td>
						</tr>
						<tr>
								...
								<div id="userSetGrid">
									<aa:zone name="gridZone">
										...
										<div style="margin-bottom:5px; ">
											<a class="small-btn" onclick="viewCondition();"><span><span><s:text name="permission.authorize.search"></s:text></span></span></a>
										</div>
						...
						<tr>
							<td class="content-title"><s:text name="permission.operatorAuth"/>：</td>
							<td><fieldset >
						...
						<tr class="">
							<td class="content-title"  id="_list_id"><s:text name="permission.listTables" />：</td>
							<td class="listTd"><input readonly="readonly" id="listViewName" value="${listViewName }" /><input type="hidden" name="listViewId" id="listViewId" value="${listViewId }"></input> &nbsp;<a class="small-btn" onclick="selectListView();"><span><span><s:text name="user.choose"/></span></span></a>&nbsp;<a class="small-btn" onclick="clearList();"><span><span><s:text name="user.empty"/></span></span></a></td>
						</tr>
					</table>
					</form>
