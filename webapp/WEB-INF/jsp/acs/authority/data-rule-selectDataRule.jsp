	...
	<script type="text/javascript">
		...
		function select(){
			...
			if(typeof(data)!='undefined'&& data!="menu"){
				...
				iMatrix.alert(iMatrixMessage["dataRule.pleaseSelectDataClassification"]);
			}
		}
	</script>
	<style type="text/css">
...
<div class="opt-body">
	...
	<aa:zone name="main_zone">
		<div class="opt-btn">
			<button class="btn" onclick="select();"><span><span ><s:text name="user.sure"></s:text></span></span></button>
		</div>
		<div id="opt-content">
