...
<div class="ui-layout-center">
	<div class="opt-body">
		<aa:zone name="pageTable">
			<div class="opt-btn">
				<button class="btn" onclick="saveOperation();"><span><span><s:text name="menuManager.save"></s:text> </span></span></button>
				<button class="btn" onclick="backPage();"><span><span ><s:text name="menuManager.back"></s:text></span></span></button>
			</div>
			<div id="opt-content">
				...
				<form action="" name="viewSaveForm" id="viewSaveForm" method="post"> 
					...
					<table class="form-table-without-border">
						<tr>
							<td class="content-title" style="width:100px"><s:text name="menuManager.code"></s:text> ：</td>
						...
						<tr>
							<td class="content-title" style="width:100px"><s:text name="menuManager.name"></s:text>：</td>
						...
						<tr>
							<td class="content-title"><s:text name="menuManager.childFunctionList"></s:text>：</td>
