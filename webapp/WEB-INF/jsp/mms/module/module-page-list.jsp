...
<form id="defaultForm" name="defaultForm"action="">
	...
	<aa:zone name="pageTable">
		<div class="opt-btn">
			<button class="btn" onclick="createView();"><span><span><s:text name="menuManager.new"></s:text></span></span></button>
			<button class="btn" onclick="updateView();"><span><span ><s:text name="menuManager.update"></s:text></span></span></button>
			<button class="btn" onclick="deleteViews();"><span><span ><s:text name="formManager.deleteThoroughly"></s:text></span></span></button>
			<button class="btn" onclick="defaultDisplaySet();"><span><span ><s:text name="pageManager.setOrCancel"></s:text></span></span></button>
			<button class="btn" onclick="enabelSet();"><span><span ><s:text name="formManager.startOrForbidden"></s:text></span></span></button>
		</div>
