		...
		function selectView(){
			if(id!=""){
				...
				if(arr[2]=="view"){
					...
					iMatrix.alert(iMatrixMessage["mms.cannotSelectMenu"]);
				}
			}else{
				iMatrix.alert(iMatrixMessage["mms.pleaseSelectPage"]);
			}
		}
	</script>
...
<div class="ui-layout-center">
	<div  class="opt-body" >
		<div class="opt-btn">
				<button class="btn" onclick="selectView();"><span><span ><s:text name="menuManager.confirm"></s:text></span></span></button>
		</div>
		<div  id="opt-content">
