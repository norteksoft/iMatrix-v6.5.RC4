	...
	<div  class="opt-body" >
		...
		<div  id="opt-content">
			<div id="tabs" style="height:auto;">
				<ul>
					<li ><a href="#tabs-1" onclick="changeSelected('edit');"><s:text name="pageManager.edit"></s:text></a></li>
					<li ><a href="#tabs-1" onclick="changeSelected('preview');preview();"><s:text name="pageManager.preview"/></a></li>
				</ul>
				<div id="tabs-1">
					<div id="div_edit" class="selected_div">
						...
						<ul style="list-style: none;">
							<li>
							<!-- 如： -->
							<s:text name="pageManager.such.as"/>
							</li>
							<li>
							<!-- 1、点击按钮时执行：  execute: toUpdateForm ，其中“toUpdateForm”为api中可执行的方法 -->
							1、<s:text name="pageManager.execute.toUpdateForm"/>
							</li>
							<li>
							<!-- 2、点击按钮时执行并在执行前或执行后执行某方法： -->
							2、<s:text name="pageManager.clickButtonExecuteFunction"></s:text>
							<ul  style="list-style: none;">
								<li>
