	...
	<head>
		...
		<script type="text/javascript">
			function submitForm(url){
				...
				if(code==""||code==null){
					iMatrix.alert(iMatrixMessage["common.please.select.the.next.tache"]);
				}else{
	...
	<div class="ui-layout-center">
		<div class="opt-body">
				<aa:zone name="main">
					<div class="opt-btn">
						<s:if test="task==null">
							<button class='btn' onclick="submitForm('${mmsCtx}/common/assign.htm')"><span><span><s:text name="submit.name"></s:text></span></span></button>
						</s:if>
					</div>
					...
					<div id="opt-content" class="form-bg">
						<form  id="selectTacheForm" name="selectTacheForm" method="post" action="">
							...
							<table class="form-table-border-left">
								<tr>
									<td><s:text name="common.select.the.next.tache"></s:text></td>
								</tr>
