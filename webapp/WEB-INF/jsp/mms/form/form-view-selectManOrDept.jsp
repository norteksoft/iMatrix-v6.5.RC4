...
<head>
  ...
  <div class="opt-body">
	<div class="opt-btn">
		<button class="btn" onclick="saveF()"><span><span><s:text name="menuManager.confirm"></s:text></span></span></button>
		...
		<aa:zone name="controlContent">
			<form name="deptForm" id="deptForm" action="${mmsCtx }/form/form-view-text.htm">
				...
				<s:hidden id="occasion" name="occasion" value="changeSource"></s:hidden>
				 <table >
				     <tr>
				      		<td><s:text name="formManager.controlName"></s:text>：</td>
				      ...
				      <tr>
							...
							<td>
								<input name="formControl.controlType.code"  id="formControl_controlType_code" type="text" readonly="readonly" value="<s:text name="%{formControl.controlType.code}"></s:text>">
						...
						<s:if test="standard">
					      ...
					      <tr>
					     	<td><s:text name="formManager.showInformationInputType"></s:text>：</td>
					     	<td>
						     	<s:select id="showDeptCotrolType" theme="simple" list="#{'input':getText('formManager.textbox'),'textArea':getText('formManager.textarea')}" name="formControl.showDeptCotrolType" >
								</s:select>
					   		</td>
					     </tr>
					      <tr >
					      		<td><s:text name="formManager.saveFieldName"></s:text>：</td>
					      		<td>
					      ...
					      <tr >
					      		<td><s:text name="formManager.saveInputControlName"></s:text>：</td>
					      ...
					      <tr >
				      		<td><s:text name="formManager.saveType"></s:text>：</td>
				      		<td><s:select id="saveDeptControlType" theme="simple" list="#{'loginName':getText('formManager.longinNameInfo'),'userId':'id'}" name="formControl.saveDeptControlType" >
								</s:select>
							</td>
				      		<td></td>
					      </tr>
				     ...
				     <tr>
				     	<td><s:text name="formManager.chooseType"></s:text>：</td>
				     	<td>
				   			<select id="deptTreeType" name="formControl.deptTreeType">
				   				<option value="COMPANY"><s:text name="formManager.company"></s:text></option>
				   				<option value="MAN_DEPARTMENT_TREE"><s:text name="formManager.manDepartTree"></s:text></option>
				   				<option value="MAN_GROUP_TREE"><s:text name="formManager.manGroupTree"></s:text></option>
				   				<option value="DEPARTMENT_TREE"><s:text name="formManager.departmentTree"></s:text></option>
				   				<option value="GROUP_TREE"><s:text name="formManager.groupTree"></s:text></option>
				   			</select>
				   			<script type="text/javascript">
				     ...
				     <tr>
				     	<td><s:text name="formManager.type"></s:text>：</td>
				     	<td>
				     		<s:select id="deptMultiple" theme="simple" list="#{'false':getText('formManager.single'),'true':getText('formManager.multiple')}" name="formControl.deptMultiple" >
							</s:select>
				   		</td>
				     </tr>
				     <tr>
						<td><s:text name="formManager.showBranch"></s:text>：</td>
						<td>
							<s:select id="deptShowBranch" theme="simple" list="#{'false':getText('common.no'),'true':getText('common.yes')}" name="formControl.deptShowBranch" >
							</s:select>
						</td>
						<td></td>	
					</tr>
