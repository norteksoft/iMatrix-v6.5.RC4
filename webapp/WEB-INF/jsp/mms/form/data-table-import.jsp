...
function submitbutt(){
	if($("#filename").val()==""){
		//请选导入的文件！
		iMatrix.alert(iMatrixMessage["task.pleaseSelectTheFileToImport"]);
	}else{
		$('#importForm').submit();
	}
}
...
<div class="opt-body">
	<div class="opt-btn">
		<button class="btn" onclick="submitbutt();"><span><span><s:text name="menuManager.confirm"></s:text></span></span></button>
	</div>
	<div id="opt-content">
