...
<head>
	...
	function addOption(){
		...
		if(val==''){
			iMatrix.alert(iMatrixMessage["pageManager.urgentInfo"]);
			return;
		}

		var redio = $("input[name='flag']:checked");
		if(redio.length==0){
			iMatrix.alert(iMatrixMessage["pageManager.flagInfo"]);
			return;
		}
				...
				<table  class="form-table-without-border">
				    <tr>
				      <td colspan="3" style="text-align:left">
				      	<s:text name="formManager.urgentInfo"></s:text>
				      </td>
				    </tr>
				    <tr>
				    ...
				    <tr>
				      <td  style="text-align:right"  class="content-title"><s:text name="formManager.urgent"></s:text>：</td>
				      <td ><s:textfield theme="simple" name="urgencyDescribe" id="urgencyDescribe" maxlength="15" /></td>
				      <td ><s:text name="formManager.wordsDescription"></s:text></td>
				    </tr>
				    <tr >
				      <td  style="text-align:right"  class="content-title">
							<s:text name="formManager.correspondingFlag"></s:text>：
					</td>
				      <td colspan="2">
					      <input type="radio" name="flag" value="0" title="<s:text name='formManager.theHighestDegreeOfUrgency.redFlag'/>" checked="checked"/><img alt="紧急程度最高:红旗" src="${mmsCtx}/images/0.gif">
					      <input type="radio" name="flag" value="1" title="<s:text name='formManager.blueFlag'/>"/><img alt="蓝旗" src="${mmsCtx}/images/1.gif">
					      <input type="radio" name="flag" value="2" title="<s:text name='formManager.yellowFlag'/>"/><img alt="黄旗" src="${mmsCtx}/images/2.gif">
					      <input type="radio" name="flag" value="3" title="<s:text name='formManager.greenFlag'/>"/><img alt="绿旗" src="${mmsCtx}/images/3.gif">
					      <input type="radio" name="flag" value="4" title="<s:text name='formManager.orangeFlag'/>"/><img alt="橙旗" src="${mmsCtx}/images/4.gif">
					      <input type="radio" name="flag" value="5" title="<s:text name='formManager.purpleFlag'/>"/><img alt="紫旗" src="${mmsCtx}/images/5.gif">
					      <input type="radio" name="flag" value="6" title="<s:text name='formManager.theMinimumDegreeOfUrgency.null'/>"/><s:text name="formManager.null"></s:text><img alt="紫旗" src="${mmsCtx}/images/6.gif">
					</td>
				    </tr>
				    <tr>
				      <td rowspan="4" align="right" valign="top"><s:text name="formManager.optionHas"></s:text>：</td>
				      ...
				      <td style="border:none">
					      <a href="#" onclick="addOption();" title="<s:text name='form.inputstandard.field.addrow'></s:text>"  class="small-btn" id="add_button"><span><span><s:text name="form.inputstandard.field.addrow"></s:text></span></span></a>
					      <a href="#" onclick="removeOption();" title="<s:text name='menuManager.delete'></s:text>"  class="small-btn" id="delete_button"><span><span><s:text name="menuManager.delete"></s:text></span></span></a>
				      </td>
				    </tr>
				  </table>
			</form>
