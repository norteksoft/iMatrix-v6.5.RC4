		...
		<aa:zone name="wf_definition">
			<aa:zone name="wf_task">
				<div class="opt-btn">
					...
					<a href="#" onclick="back_main();" class="btnStyle "><s:text name="menuManager.back"></s:text></a>
					<button class="btn" onclick="ajaxSubmit('defaultForm','${wfCtx}/engine/workflow-collection.htm','myprocess');"><span><span ><s:text name="menuManager.back"></s:text></span></span></button>
				</div>
