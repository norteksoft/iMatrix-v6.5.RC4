...
<head>
	...
	$(function () {
		...
		var html = '<button class="btn" onclick="OK();" hidefocus="true"><span><span><s:text name="menuManager.confirm"></s:text></span></span></button>';
		$("#myp").html(html);
		rankTree();
	...
	function selectContact(id){
		if(id=="companyli"){
			...
			var html = '<button class="btn" onclick="OK();"  hidefocus="true">'
				+'<span><span><s:text name="menuManager.confirm"></s:text></span></span></button>';
		...
		if(value!=""){
			...
			for(var i=0;i<arr.length;i++){
				if(arr[i].type=="allDepartment" || arr[i].type=="company"){
					$("#personnelNames").attr("value",iMatrixMessage["common.allPersonnel"]);
	...
	function selectDeptAndWorkGroup(){
		if($("#personnelNames").attr("value")!=iMatrixMessage["common.allPersonnel"]){
...
<aa:zone name="treeList"></aa:zone>
		<div id="tabs">
			<ul>
				<li ><a href="#tabs-1" onclick="selectContact('companyli');"><s:text name="wf.dictionary.selectPersonnel"></s:text></a></li>
				<li ><a href="#tabs-1" onclick="selectContact('userli');"><s:text name="wf.dictionary.selectDepartment"></s:text></a></li>
				<li ><a href="#tabs-1" onclick="selectContact('rankli');"><s:text name="wf.dictionary.selectTheUser"></s:text></a></li>
			</ul>
			<div id="tabs-1">
