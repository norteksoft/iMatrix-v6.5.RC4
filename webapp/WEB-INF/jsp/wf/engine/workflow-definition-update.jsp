...
<aa:zone name="wfd_main">
	<s:if test="option=='view'">
		<div class="opt-btn">
			<button  class='btn' onclick="setPageState();goBackWfd('wfdForm','${wfCtx}/engine/workflow-definition-data.htm','wfd_main','wfdPage');" hidefocus="true"><span><span><s:text name="menuManager.back"></s:text></span></span></button>
		</div>
	</s:if>
	...
	<input type="hidden" name="localeLang" id="localeLang" value="<%= com.norteksoft.product.util.ContextUtils.getCurrentLanguage() %>" />
