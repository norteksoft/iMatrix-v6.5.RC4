	...
	<div class="opt-body">
		<aa:zone name="wf_task">
			<div style="width:auto; padding: 0; margin: 0;text-align: left;" id="leafTree">
				<div class="opt-btn">
					<button id="wf_ok" class='btn' onclick="OK();" hidefocus="true"><span><span><s:text name="menuManager.confirm"></s:text></span></span></button>
				</div>
			   	<div id="opt-content">
			   		<s:if test="forkTask">
			   			...
			   			<font color="red"><s:text name="wf.text.theCurrentTaskFor"></s:text></font>
			   		</s:elseif><s:else>
			   			<ztree:ztree
