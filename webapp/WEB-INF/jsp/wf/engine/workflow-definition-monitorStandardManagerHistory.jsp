	...
	<div class="ui-layout-center">
		...
		<aa:zone name="wf_definition">	
			<div class="opt-btn">
				...
				<button class='btn' onclick="urgen_done_history();" hidefocus="true"><span><span><s:text name="wf.button.emergencyHandling"></s:text></span></span></button>
				</security:authorize>
				<security:authorize ifAnyGranted="wf_engine_wf_definition_deleteWorkflow">	
				<button class='btn' onclick="delete_monitor_workflow_history('standardManager');" hidefocus="true"><span><span><s:text name="menuManager.delete"></s:text></span></span></button>
				</security:authorize>
			</div>
