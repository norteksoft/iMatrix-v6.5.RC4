...
<div class="opt-body">
	<aa:zone name="myprocess">
			...
			<div id="opt-content" >
				<div id="tabs">
						<ul>
							<li><a href="#tabs-1" onclick="changeDelegateList('current');"><s:text name="wf.engine.current.task"></s:text></a></li>
							<li><a href="#tabs-1" onclick="changeDelegateList('history');"><s:text name="wf.engine.history.task"></s:text></a></li>
						</ul>
					<div id="tabs-1">
