...
<div class="opt-body">
	...
	<div class="opt-btn">
		...
		<button  class='btn' onclick="viewDict('');" hidefocus="true"><span><span><s:text name="menuManager.new"></s:text></span></span></button>
		<button class='btn' onclick="deleteDict('${wfCtx}/engine/data-dictionary-delete.htm','dictPage');" hidefocus="true"><span><span><s:text name="menuManager.delete"></s:text></span></span></button>
	</div>
