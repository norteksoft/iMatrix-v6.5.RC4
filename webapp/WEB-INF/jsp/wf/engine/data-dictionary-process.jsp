...
<div class="ui-layout-center">
	<aa:zone name="dict_zone">
		<div class="opt-btn">
			<button  class='btn' onclick="submitProcesses();" hidefocus="true"><span><span><s:text name="menuManager.confirm"></s:text></span></span></button>
			<button class='btn' onclick="window.parent.$('#addProcess').colorbox.close();" hidefocus="true"><span><span><s:text name="menuManager.back"></s:text></span></span></button>
		</div>
