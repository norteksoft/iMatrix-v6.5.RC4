...
<div class="opt-body">
	<s:if test="isDone">
		...
		--><div id="tabs">
			<ul>
				<li><a href="#tabs-1" onclick="changeViewSet('false');"><s:text name="wf.engine.current.task"></s:text></a></li>
				<li><a href="#tabs-1" onclick="changeViewSet('true');"><s:text name="wf.engine.history.task"></s:text></a></li>
			</ul>
			<div id="tabs-1">
