...
<input type="hidden" name="type" value="${type }" /></form>
		<div class="opt-btn">
			<button id="createInst" class='btn' onclick="ok();" hidefocus="true"><span><span><s:text name="menuManager.confirm"></s:text></span></span></button>
			<button class='btn' onclick="window.parent.$('#add').colorbox.close();" hidefocus="true"><span><span><s:text name="process.cancel"></s:text></span></span></button>
		</div>
		<ul>
		...
		<aa:zone name="template">
			...
			<table style="border: 0px;">
				<tr>
					...
					<span style="font-size: 10pt;"><s:text name="wf.definition.blank"></s:text></span></td>
			...
			<div class="viewImg">
				<p style="color: #4D87C7; margin-left: 20px; margin-top: 2px"><s:text name="wf.definition.previewDiagram"></s:text></p>
