...
<div class="opt-body">
	<aa:zone name="wf_template">
		<div class="opt-btn">
			...
			<button class='btn' onclick="setPageState();back($('#wf_type').val());" hidefocus="true"><span><span><s:text name="menuManager.back"></s:text></span></span></button>
		</div>
		...
		<table>
			...
			<tr>
				...
				<td id="discriptTip"><s:text name="wf.template.maximumInput600"></s:text></td>
			</tr>
		</table>
		</form>
	</aa:zone>	
