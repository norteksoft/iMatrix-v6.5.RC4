...
<div class="opt-body">
	<aa:zone name="wf_definition">
		...
		<div class="opt-btn">
			...
			<button id="backbutton" class="btn" onclick="back_main();"><span><span ><s:text name="menuManager.back"></s:text></span></span></button>
		</div>
		<div id="opt-content" >
			<div id="tabs">
				<ul>
					<li ><a href="#tabs-1" onclick="changeDefTab('a1', '${wfdId}')"><s:text name="wf.definition"></s:text></a></li>
					<li ><a href="#tabs-1" onclick="changeDefTab('b1', '${wfdId}')"><s:text name="wf.form"></s:text></a></li>
				</ul>
				<div id="tabs-1">
