...
<div class="opt-body">
	...
	<aa:zone name="dict_zone">
		<div class="opt-btn">
			<button  class='btn' onclick="viewDictType('add');" hidefocus="true"><span><span><s:text name="menuManager.new"></s:text></span></span></button>
			<button class='btn' onclick="deleteDictType('${wfCtx}/engine/data-dictionary-type-delete.htm');" hidefocus="true"><span><span><s:text name="menuManager.delete"></s:text></span></span></button>
		</div>
