...
<div class="opt-body">
	<aa:zone name="myprocess">
		<div id="opt-content" >
			<view:jqGrid url="${wfCtx}/engine/delegate-main-myAccept.htm?isDone=true&inHistory=true" pageName="historyTasks" code="WORKFLOW_HISTORY_TASK_ACCEPT" gridId="main_table"></view:jqGrid>
		</div>
	</aa:zone>
