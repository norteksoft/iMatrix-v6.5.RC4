...
<form action="" name="defaultForm" id="defaultForm" method="post"></form>
	<div class="opt-btn">
		<button class="btn" onclick="ajaxSubmit('defaultForm','${wfCtx}/engine/delegate-main-receive.htm','delegatemainlist');"><span><span><s:text name="menuManager.back"></s:text></span></span></button>
	</div>
	<div id="opt-content">
	<table class="Table">
	 		<tr style="height: 30px;">
				<td style="width: 80px;"><s:text name="wf.table.principal"></s:text>：</td>
				<td>${trustorName }
				 </td>
		  	</tr>
		  	<tr style="height: 30px;">
