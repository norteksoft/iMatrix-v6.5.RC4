		...
		<aa:zone name="wf_task">
			<div class="opt-btn">
				<s:if test="canChoiceTransactor.size>0">
					<button id="submitFormButton" class='btn' onclick="okBtn();" hidefocus="true"><span><span><s:text name="menuManager.confirm"></s:text></span></span></button>
				</s:if>
				<button class='btn' onclick="back_main();" hidefocus="true"><span><span><s:text name="menuManager.back"></s:text></span></span></button>
			</div>
			<div id="opt-content" class="form-bg">
				...
				<s:if test="canChoiceTransactor.size>0">
					...
					<s:text name="wf.taskJumpChoiceTransactor.tache"></s:text>【${backto }】<s:text name="wf.taskJumpChoiceTransactor.chooseUser"></s:text>
					<table class="form-table-border-left">
						<thead>
							<tr>
							<th><input id="_all" type="checkbox" onclick="_select_all('_all','tranName');"></input></th>
							<th><s:text name="wf.taskJumpChoiceTransactor.userName"></s:text></th>
							<th><s:text name="wf.taskJumpChoiceTransactor.loginName"></s:text></th>
							</tr>
						</thead>
						<tbody>
