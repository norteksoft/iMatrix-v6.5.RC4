...
function callBack(){
	showMsg();
	$($("#searchBtn").children().children()).html(iMatrixMessage["wf.engine.query"]);
	$("#taskIdDiv").html("");
	contentResize();
	getContentHeight();
}
...
<div class="ui-layout-center" style="top:0;left:0;border: 0px;">
	...
	<aa:zone name="wfd_main">
		<div class="opt-btn">
			...
			<button class='btn' onclick="deleteTasks();" ><span><span><s:text name="wf.monitoring.executiveRemoval"></s:text></span></span></button>
		</div>
		<div id="opt-content" >
