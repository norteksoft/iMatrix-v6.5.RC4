	...
	<form id="updateForm" action="" name="updateForm" method="post"></form>
		<div class="opt-btn">
			...
			<security:authorize ifAnyGranted="wf_engine_workflow-definition-template-input">
				<button  class='btn' onclick="createWorkflowDefinitionTemplate('${wfCtx}/engine/workflow-definition-template-input.htm');" hidefocus="true"><span><span><s:text name="menuManager.new"></s:text></span></span></button>
				<button class='btn' onclick="updateWorkflowDefinitionTemplate('${wfCtx}/engine/workflow-definition-template-input.htm');" hidefocus="true"><span><span><s:text name="menuManager.update"></s:text></span></span></button>
			</security:authorize>
			<security:authorize ifAnyGranted="wf_engine_workflow-definition-template-delete ">
				<button class='btn' onclick="deleteWorkflowDefinitionTemplate('${wfCtx}/engine/workflow-definition-template-delete.htm');" hidefocus="true"><span><span><s:text name="menuManager.delete"></s:text></span></span></button>
			</security:authorize>
		</div>
