...
public class User extends IdEntity {
	...
	private String mainDepartmentName;//正值部门名称
	...
	public String getMainDepartmentName() {
		if(mainDepartmentId!=null){
			com.norteksoft.product.api.entity.Department dept=ApiFactory.getAcsService().getDepartmentById(mainDepartmentId);
			if(dept!=null){
				mainDepartmentName=dept.getName();
			}
		}
