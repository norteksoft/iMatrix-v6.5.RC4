...
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentLoginName;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUser;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserBranch;
...
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserDirectLowerBranch;
...
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserDirectSuperiorBranch;
...
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserMainDepartment;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserMainDepartmentName;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserName;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserRole;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserRoleName;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.CurrentUserRoles;
...
import com.norteksoft.acs.base.utils.permission.impl.dataRule.advanced.UserConditionValueCreater;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.simpleness.AllDataValue;
import com.norteksoft.acs.base.utils.permission.impl.dataRule.simpleness.BranchValue;
...
public class PermissionAnalysisFactory {
	...
	public static DataRuleConditionValueSetting getDataRuleConditionValueSetting(String conditionValue){
		...
		if(conditionValue==null){
			...
			}else if(StringUtils.trim(conditionValue).equals(ConditionType.CURRENT_USER_BRANCH.toString())){//当前用户分支
				valueSetting=new CurrentUserBranch();
			}else if(StringUtils.trim(conditionValue).equals(ConditionType.CURRENT_USER_DIRECT_SUPERIOR_BRANCH.toString())){//直属上级的分支
				valueSetting=new CurrentUserDirectSuperiorBranch();
			}else if(StringUtils.trim(conditionValue).equals(ConditionType.CURRENT_USER_DIRECT_LOWER_BRANCH.toString())){//直属下级的分支
				valueSetting=new CurrentUserDirectLowerBranch();
			}else{
				if(StringUtils.trim(conditionValue).equals("~~currentUser")){
					valueSetting=new CurrentUserName();
				}else if(StringUtils.trim(conditionValue).equals("~~currentLoginName")){
					valueSetting=new CurrentLoginName();
				}else if(StringUtils.trim(conditionValue).equals("~~currentUserDepartment")){
					valueSetting=new CurrentUserMainDepartment();
				}else if(StringUtils.trim(conditionValue).equals("~~currentUserRole")){
					valueSetting=new CurrentUserRoles();
				}else if(StringUtils.trim(conditionValue).indexOf("beanName:")==0){
					valueSetting=new UserConditionValueCreater();
				}else if(StringUtils.trim(conditionValue).equals("~~currentUserMainDepartmentName")){
					valueSetting=new CurrentUserMainDepartmentName();
				}else if(StringUtils.trim(conditionValue).equals("~~currentUserRoleName")){
					valueSetting=new CurrentUserRoleName();
				}else{
	...
	public static DataRangeSetting getDataRangeSetting(DataRange range,Boolean deparmentInheritable){
		...
		}else if(range==DataRange.ALL_BRANCH){
			rangeSetting = new BranchValue();
		}
		return rangeSetting;
	}
	/**
