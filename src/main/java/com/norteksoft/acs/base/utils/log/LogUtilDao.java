...
//	}
    ...
    public void debugLog(String optType, String message,OperatorType operatorType){
    	Log log = createLog(message, null);
		log.setMessage(message);
		log.setOperationType(optType);
		log.setOperatorType(operatorType);
		log.setAdminLog(isAdmin(operatorType));
		logDao.save(log);
    }
     ...
     * @param message   日志信息
     */
    public void debugLog(String operatorName, String optType, String message,OperatorType operatorType){
    	Log log = createLog(message, null);
     ...
     * @param operatorLoginName 操作人登录名
     * @param optType   操作类型
     * @param message   日志信息
     */
    public void debugLog(String operatorName,String operatorLoginName, String optType, String message,OperatorType operatorType){
    	Log log = createLog(message, null);
    	log.setOperator(operatorName);
...
//	}
	...
	private boolean isAdmin(OperatorType operatorType){
		if(operatorType==OperatorType.COMMON_USER){
			return false;
		}
		return true;
	}
