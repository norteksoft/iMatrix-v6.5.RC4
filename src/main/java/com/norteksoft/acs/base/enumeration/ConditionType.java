...
public enum ConditionType {
	 ...
	 * 当前用户分支
	 */
	CURRENT_USER_BRANCH("permission.item.type.currentUserBranch"),
	/**
	 * 当前用户直属上级的分支
	 */
	CURRENT_USER_DIRECT_SUPERIOR_BRANCH("permission.item.type.currentUserDirectSuperiorBranch"),
	/**
	 * 当前用户直属下级的分支
	 */
	CURRENT_USER_DIRECT_LOWER_BRANCH("permission.item.type.currentUserDirectLowerBranch");
	public String code;
