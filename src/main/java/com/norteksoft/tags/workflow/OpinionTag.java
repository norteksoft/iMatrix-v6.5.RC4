...
public class OpinionTag extends TagSupport {
	...
	private String readTemplet(List<Opinion> opinions, String workflowId,List<HistoryOpinion> histOpinions,boolean instanceInHistory) throws Exception {
		...
		root.put("caterer", Struts2Utils.getText("caterer"));
		root.put("content", Struts2Utils.getText("content"));
		root.put("date", Struts2Utils.getText("date"));
		root.put("tache", Struts2Utils.getText("tache"));
		root.put("companyId", Struts2Utils.getText("tache"));
