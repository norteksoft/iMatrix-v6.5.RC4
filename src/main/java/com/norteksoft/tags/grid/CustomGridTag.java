...
//		return SKIP_BODY;
	...
	private String readTemplate() throws Exception {
		...
		if(listVeiwEntity!=null){
			data=formHtmlParser.getJsonData(listVeiwEntity.getColumns(),listView.getColumns(),gridId);
		}else{
			data=formHtmlParser.getJsonData(new ArrayList(),listView.getColumns(),gridId);
		}
