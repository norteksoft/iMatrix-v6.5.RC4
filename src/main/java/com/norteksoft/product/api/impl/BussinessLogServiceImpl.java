...
public class BussinessLogServiceImpl implements BussinessLogService {
	...
	public String getI18nLogInfo(String code) {
		return getI18nLogInfo(code,getI18nLanguage());
	}
	
	private String getI18nLanguage(){
		SecuritySetting securitySetting =securitySetManager.getSystemValues(ContextUtils.getCompanyId(), "system-default-language");
		String language = "zh_CN";
		if(securitySetting!=null && "ENGLISH".equals(securitySetting.getValue())){//英文
			language = "en_US";
		}
		return language;
	}
	
	public String getI18nLogInfo(String code, String language) {
		return ApiFactory.getSettingService().getInternationOptionValue(code, language, InternationType.LOG_RESOURCE.toString());
	}

	public String getI18nLogInfo(String code, List<String> messages) {
		return getI18nLogInfo(code,getI18nLanguage(),messages);
	}

	public String getI18nLogInfo(String code, String language,
			List<String> messages) {
		return ApiFactory.getSettingService().getInternationOptionValue(code, language, InternationType.LOG_RESOURCE.toString(),messages);
	}
}
