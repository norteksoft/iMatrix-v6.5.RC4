...
public interface AcsService {
	...
	/**
	 * 获取全公司内不属于任何部门的用户个数(不包含分支机构内的无部门用户)
	 * @return List<User>
	 */
	...
	/**
	 * 根据登录名或邮箱或手机号码查询用户信息(单个公司)
	 * 当存在多分支机构时会存在登录名重复的情况， 请用<code>User getUserByLoginNameOrEmailOrMobileTelephoneAndBranchId(String name,Long branchId) 或 User  getUserByLoginNameOrEmailOrMobileTelephoneAndBranchCode(String name,String branchCode)</code>
	 * @param name：登录名或邮箱或手机号码
	 * @return
	 */
	public User getUserByLoginNameOrEmailOrMobileTelephone(String name);
	
	/**
	 * 根据登录名或邮箱或手机号码查询用户信息(多分支机构情况)
	 * @param name：登录名或邮箱或手机号码
	 * @param branchId：只能是分支机构id，如果为空，则表示在集团下查询该登录名的用户
	 * @return
	 */
	 ...
	 * @return
	 */
	public  long getChildDepartmentCount(Long departmentId);
	/**
	 * 根据公司id获得公司
	 * @param companyId
	 * @return
	...
	/**
	 * 判断当前角色roleCode是否是管理员角色：安全管理员、系统管理员、审计管理员、分支机构管理员
	 * @param roleCode
	...
	/**
	 * 根据用户姓名模糊查询全公司内不属于任何部门的用户个数(不包含分支机构内的无部门用户)
	 * @param userName 用户姓名
	 * @return List<User>
	 */
	public Long getUsersWithoutDepartmentCountByUserName(String userName);
	/**
	 * 根据用户姓名模糊查询分支机构内不属于任何部门的用户个数
	...
	/**
	 * 根据用户姓名模糊查询分支机构内不属于任何部门的分支机构的集合
	 * @param userName 用户姓名
	 * @return List<User>
	 */
