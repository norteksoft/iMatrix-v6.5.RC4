...
public class ContextUtils {
    ...
    public static String getSystemName(){
    	String systemName = ParameterUtils.getSystemName();
	...
	public static boolean isAuthority(String url,BusinessSystem system){
		if(system!=null){
	...
	public static String getPassword(){
		String password = ParameterUtils.getPassword();
	...
	public static String getCurrentLanguage(){
		return getCurrentUser().getCurrentLanguage();
	}
	
	public static void setCurrentLanguage(String currentLanguage){
		getCurrentUser().setCurrentLanguage(currentLanguage);
	}
