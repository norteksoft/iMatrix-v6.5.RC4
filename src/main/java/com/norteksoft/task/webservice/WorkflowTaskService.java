...
public interface WorkflowTaskService {
	...
	//2014-5-22
	void getTaskAsAccept( Page<WorkflowTask> page, boolean isEnd);
	void getHistoryTaskAsAccept( Page<HistoryWorkflowTask> page, boolean isEnd);
	...
	//2014-5-22 1
	Integer getAcceptTasksNum(Boolean isCompleted);
...
//		 * @return
//		 */
//		public Integer getOverdueTaskNumByTransactor(Long transactorId,String transactor);
//		/**
//		 * 查询办理人的过期次数
//		 * @param transactorId
//		 * @param transactor
//		 * @return
//		 */
//		public Integer getOverdueHistoryTaskNumByTransactor(Long transactorId,String transactor);
		/**
		 * 查询办理人的所有超期任务
		 * @param page
		 * @param transactorId
		 ...
		 * @param transactorId
		 */
		public void getTransferTaskDetails(Page<WorkflowTask> page,Long transactorId,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd);
		public void getTransferHistoryTaskDetails(Page<HistoryWorkflowTask> page,Long transactorId,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd);
