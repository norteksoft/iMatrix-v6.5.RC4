...
public class WorkflowTaskServiceImpl implements WorkflowTaskService{
	...
	public void deleteSignHandlerByTaskId(Collection<Long> taskIds) {
		taskManager.deleteSignHandlerByTaskId(taskIds);
		
	}

	public List<WorkflowTask> getActivityReminderTasksByInstance(
			String instanceId, Long companyId) {
		return taskManager.getActivityReminderTasksByInstance(instanceId, companyId);
	}

	public void getOverdueTasks(Page<WorkflowTask> page) {
		taskManager.getOverdueTasks(page);
		
	}

	public void getOverdueHistoryTasks(Page<HistoryWorkflowTask> page) {
		taskManager.getOverdueHistoryTasks(page);
		
	}

	public List<Long> getTaskIdsByName(Long companyId, String instanceId,
			String[] taskNames) {
		return taskManager.getTaskIdsByName(companyId, instanceId, taskNames);
	}
	...
	public void getOverdueTaskTransactors(Page<Object> page,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd){
		taskManager.getOverdueTaskTransactors(page,transactorName,lastTransactTimeStart,lastTransactTimeEnd);
	}
	

	public void getOverdueTaskDetails(Page<WorkflowTask> page,
			Long transactorId, String transactor,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd) {
		taskManager.getOverdueTaskDetails(page, transactorId, transactor,transactorName,lastTransactTimeStart,lastTransactTimeEnd);
	...
	public void getOverdueHistoryTaskTransactors(Page<Object> page,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd){
		taskManager.getOverdueHistoryTaskTransactors(page,transactorName,lastTransactTimeStart,lastTransactTimeEnd);
	}
	
	
	public void getOverdueHistoryTaskDetails(Page<HistoryWorkflowTask> page,
			Long transactorId, String transactor,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd) {
		taskManager.getOverdueHistoryTaskDetails(page, transactorId, transactor,transactorName,lastTransactTimeStart,lastTransactTimeEnd);
		
	}

	public List<Object[]> getTransactorsByTaskIds(List<Long> taskIds) {
		return taskManager.getTransactorsByTaskIds(taskIds);
	}
	
	public void getTransferTasksByTaskId(Long taskId,Page<WorkflowTask> page){
		taskManager.getTransferTasksByTaskId(taskId, page);
	}
	
	public void getTransferHistoryTasksByTaskId(Long taskId,Page<HistoryWorkflowTask> page){
		taskManager.getTransferHistoryTasksByTaskId(taskId, page);
	}


	//2014-5-22
	public Integer getAcceptTasksNum(Boolean isCompleted) {
		return taskManager.getAcceptTasksNum(isCompleted);
	}

	public void getTaskAsAccept(Page<WorkflowTask> page, boolean isEnd) {
		taskManager.getTaskAsAccept(page, isEnd);
	}
	public void getHistoryTaskAsAccept(Page<HistoryWorkflowTask> page, boolean isEnd) {
		taskManager.getHistoryTaskAsAccept(page, isEnd);
	}
	public Integer getTransferTaskNumByTransactorId(Long transactorId,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd){
		return taskManager.getTransferTaskNumByTransactorId(transactorId,transactorName,lastTransactTimeStart,lastTransactTimeEnd);
	}
	...
	public void getTransferHistoryTaskDetails(Page<HistoryWorkflowTask> page,
		...
		taskManager.getTransferHistoryTaskDetails(page, transactorId,transactorName,lastTransactTimeStart,lastTransactTimeEnd);
		
	}

	public void getTransferTaskDetails(Page<WorkflowTask> page,
			Long transactorId,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd) {
		taskManager.getTransferTaskDetails(page, transactorId,transactorName,lastTransactTimeStart,lastTransactTimeEnd);
	...
	public Integer getTransferHistoryTaskNumByTransactorId(Long transactorId,String transactorName,String lastTransactTimeStart,String lastTransactTimeEnd) {
		return taskManager.getTransferHistoryTaskNumByTransactorId(transactorId,transactorName,lastTransactTimeStart,lastTransactTimeEnd);
	}

	public void completeOtherTranferTask(Long transferTaskId,Long taskId) {
		taskManager.completeOtherTranferTask(transferTaskId,taskId);
	}
	public List<String> selectOtherTranferTaskTransactorName(Long transferTaskId,Long taskId){
		return taskManager.selectOtherTranferTaskTransactorName(transferTaskId, taskId);
	}
	
	public Integer getTransferTaskNumByActive(Long transactorId, Boolean isCompleted){
		return taskManager.getTransferTaskNumByActive(transactorId,isCompleted);
	}
	public List<Long> selectOtherTranferTaskTransactorId(Long transferTaskId,Long taskId){
		return taskManager.selectOtherTranferTaskTransactorId(transferTaskId, taskId);
	}
	...
	public void getTransferTasksByActive(Page<WorkflowTask> page,Long transactorId, boolean isCompleted){
		taskManager.getTransferTasksByActive(page, transactorId,isCompleted);
	}
	/**
	 * 设置催办信息
	 */
	public void setTaskRemindInfo(WorkflowTask task,
			Map<String, String> reminderSetting, WorkflowInstance wi) {
		taskManager.setTaskRemindInfo(task, reminderSetting, wi);
	...
	public void setLastTransactTime(WorkflowTask task) {
		taskManager.setLastTransactTime(task);
	}

	public String parseUserCondition(WorkflowTask task, String userCondition,
			WorkflowInstance instance) {
		return taskManager.parseUserCondition(task, userCondition, instance);
	}

	public List<Long> selectOtherTranferTaskIds(Long transferTaskId, Long taskId) {
		return taskManager.selectOtherTranferTaskIds(transferTaskId, taskId);
	}

	public void clearRemindInfo(WorkflowTask targetTask) {
		taskManager.clearRemindInfo(targetTask);
	...
	public List<WorkflowTask> getCompleteTasks(Long companyId,String closeSign) {
		return taskManager.getCompleteTasks(companyId,closeSign);
	}
	...
	public List<WorkflowTask> getDidNotDealWithTasks(Long companyId,String pushSign) {
		return taskManager.getDidNotDealWithTasks(companyId,pushSign);
	}
}
