...
//	private Log log = LogFactory.getLog(HistoryWorkflowTaskManager.class);
	...
	//2014-5-22
	public Page<HistoryWorkflowTask> getTaskAsAccept(Page<HistoryWorkflowTask> tasks, Boolean isEnd) {
		return historyWorkflowTaskDao.getTaskAsAccept( tasks, isEnd);
	}
	/**
	...
	public void getHistoryTransferTasksByActive(Page<HistoryWorkflowTask> historyTasks, Long userId) {
		historyWorkflowTaskDao.getHistoryTransferTasksByActive(historyTasks,userId);
	}
