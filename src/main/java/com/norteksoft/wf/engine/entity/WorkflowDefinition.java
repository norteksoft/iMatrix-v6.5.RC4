...
public class WorkflowDefinition extends IdEntityNoExtendField implements Serializable,Cloneable{
	...
	public WorkflowDefinition clone(){
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("WorkflowDefinition clone failure");
		}
	}
