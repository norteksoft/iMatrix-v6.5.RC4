...
public class HistoryWorkflowInstanceManager{
	 ...
	 * 查询流程实例的办理意见
	 */
	public HistoryOpinion getOpinionsById(Long opinionId) {
		return historyOpinionDao.get(opinionId);
	}
	...
	public List<HistoryWorkflowInstance> getHistoryWorkflowInstances(
			String processInstanceId) {
		return historyWorkflowInstanceDao.getHistoryWorkflowInstances(processInstanceId);
	}
