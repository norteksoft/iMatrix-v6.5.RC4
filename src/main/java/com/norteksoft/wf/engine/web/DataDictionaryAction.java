...
public class DataDictionaryAction  extends CrudActionSupport<DataDictionary>{
	...
	public String list() throws Exception {
		if(dictPage.getPageSize()>1){
			...
			ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionary"), 
					ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionaryList"), 
	...
	public String input() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionary"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionaryFormlist"), 
				ContextUtils.getSystemId("wf"));
		log.debug("***input方法结束");
		return "data-dictionary-input";
	}

	@Override
	@Action("data-dictionary-save")
	public String save() throws Exception {
		...
		id = dataDict.getId();
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionary"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.saveDataDictionary"), 
				ContextUtils.getSystemId("wf"));
	...
	public String delete() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionary"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.deleteDataDictionary"), 
				ContextUtils.getSystemId("wf"));
	 ...
	 * @throws Exception
	 */
	@Action("data-dictionary-addUsers")
	public String addUsers() throws Exception {
		operate = IS_ADD;
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionary"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.addUserPage"), 
				ContextUtils.getSystemId("wf"));
		return "data-dictionary-user";
	}
	 ...
	 * @throws Exception
	 */
	@Action("data-dictionary-addProcesses")
	public String addProcesses() throws Exception {
		operate = IS_ADD;
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionary"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.addTachePage"), 
				ContextUtils.getSystemId("wf"));
		return "data-dictionary-process";
	}
...
//	}
	...
	//流程树
	@Action("data-dictionary-createProcessTree")
	public String createProcessTree() throws Exception{
		...
		ZTreeNode node=null;
		node = new ZTreeNode("all_","0",Struts2Utils.getText("wf.menu.allProcess"), "true", "false", "", "", "root", "");
		treeNodes.add(node);
		getProcessTree(treeNodes,"all_");
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionary"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.showFLowTree"), 
				ContextUtils.getSystemId("wf"));
	...
	//上下级关系树
	@Action("data-dictionary-createRankTree")
	public String createRankTree() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionary"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.rankRelationTree"), 
				ContextUtils.getSystemId("wf"));
		renderText(JsonParser.object2Json(treeNodes));
		log.debug(new StringBuilder("*** Result:[")
		.append("tree:").append(JsonParser.object2Json(treeNodes).toString())
