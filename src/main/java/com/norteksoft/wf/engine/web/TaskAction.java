...
//	private List<Long> transactorIds = new ArrayList<Long>();
	private List<String> transactorIdStrs = new ArrayList<String>();
...
//	private String exceptionSelectFlag="false";//用于标识当是批量环节跳转时，且由于异常情况而无法获得办理人时
	...
	private Page<WorkflowTask> page = new Page<WorkflowTask>(0,true);
	...
	public String backView() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("acs.workflowMonitor"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("	wf.jumoTachePage"), 
	...
	public String goback() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("acs.workflowMonitor"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.executeTacheJump"), 
				ContextUtils.getSystemId("wf"));
	...
	public String volumeBackView() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("acs.workflowMonitor"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.batchJumpTachePage"), 
				ContextUtils.getSystemId("wf"));
		return SUCCESS;
	}
	/**
	...
	public String volumeBack() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("acs.workflowMonitor"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.executeBatchTacheJump"), 
				ContextUtils.getSystemId("wf"));
		renderText(msg);
		return null;
	}
	 ...
	 * @throws Exception
	 */
	@Action("task-taskJumpAssignTransactor")
	public String taskJumpAssignTransactor()throws Exception {
		return "task-assignTransactor";
	}
	/**
	 * 环节跳转选择办理人页面
	 ...
	 * @throws Exception
	 */
	@Action("task-taskJumpChoiceTransactor")
	public String taskJumpChoiceTransactor()throws Exception {
		...
		return "task-taskJumpChoiceTransactor";
	}
	...
	public String opinion() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowAssembly"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.opintionList"),
				ContextUtils.getSystemId("wf"));
		return "task-opinion";
	}
	...
	public String list() throws Exception {
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowPlatform"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.myTaskUnfinished"), 
				ContextUtils.getSystemId("wf"));
		return SUCCESS;
	}
	...
	public String completed() throws Exception{
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowPlatform"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.myTaskFinished"), 
				ContextUtils.getSystemId("wf"));
		return "completed";
	}
	...
	public String input() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.transactTaskPage"), 
				ContextUtils.getSystemId("wf"));
	...
	public String receive() throws Exception {
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.receiveTask"), 
				ContextUtils.getSystemId("wf"));
	...
	private String preView(String operate){
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.viewFinishedTask"), 
				ContextUtils.getSystemId("wf"));
	...
	public String submit() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.submitForm"), 
				ContextUtils.getSystemId("wf"));
		return to;
	}
	...
	public String choiceTache() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.chooseTachepage"), 
				ContextUtils.getSystemId("wf"));
		return "choiceUrl";
	}
	...
	public String save() throws Exception {
		...
		log.debug(new StringBuilder("*** Received parameter:[")
			...
			.append("]").toString());
			ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowManagement"), 
					ApiFactory.getBussinessLogService().getI18nLogInfo("wf.saveTask"), 
					ContextUtils.getSystemId("wf"));
			//如果为分发环节,指定被分发人
	...
	public String assignTransactor() throws Exception{
		...
		if(task.getId()==null){
			...
			case RETURN_URL:
				...
				this.addErrorMessage(Struts2Utils.getText("wf.engine.choosePeople"));
				to = "assign";
				break;
			case TACHE_CHOICE_URL:
				addActionMessage(Struts2Utils.getText("wf.engine.pleaseSelectLink"));
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.assignTransactor"), 
				ContextUtils.getSystemId("wf"));
		return to;
	}
	...
	public String assignTo() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.finishAssignTask"), 
				ContextUtils.getSystemId("wf"));
	 ...
	 * @throws Exception
	 */
	@Action("task-changeTransactorSave")
	public String changeTransactorSave() throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("acs.workflowMonitor"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.changeTransactor"), 
				ContextUtils.getSystemId("wf"));
		this.addSuccessMessage(Struts2Utils.getText("wf.theManagerHasChanged"));
	 ...
	 * @throws Exception
	 */
	@Action("task-flowHistory")
	public String flowHistory() throws Exception {
		companyId = ContextUtils.getCompanyId();
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowPlatform"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.viewHistory"), 
				ContextUtils.getSystemId("wf"));
		return "flowHistory";
	}
	...
	public String retrieve() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.workflowPlatform"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.backTask"), 
				ContextUtils.getSystemId("wf"));
		return input();
	}
	 ...
	 * @throws Exception
	 */
	@Action("task-delTransactorSave")
	public String delTransactorSave() throws Exception{
		taskService.delTransactor(workflowId,transactorLoginNames, transactorIdStrs);
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("acs.workflowMonitor"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.reduceTransactor"), 
				ContextUtils.getSystemId("wf"));
	...
	public String delTransactor() throws Exception {
		...
		return "task-delTransactor";
	}
	@Action("task-delTransactorTree")
	public String delTransactorTree() throws Exception{
		...
		String rootId = "company_company-company~company=company";
		node = new ZTreeNode(rootId,"0",name, "true", "false", "", "", "root", "");
		treeNodes.add(node);
		...
		if(transactNum>1){
			...
			for(WorkflowTask t : taskList){
				if(t.getProcessingMode()!=TaskProcessingMode.TYPE_READ){//表示不是抄送任务
					if(hasBranch){
						if(StringUtils.isEmpty(t.getTrustorName())){
							node = new ZTreeNode("user_"+ t.getTransactorName()+"-"+t.getTransactor()+"~"+(t.getTransactorId()==null?"":t.getTransactorId())+"="+t.getId(),rootId,t.getTransactorName()+"/"+t.getTransactorSubCompanyName(), "true", "false", "", "", "user", "");
						}else{
							node = new ZTreeNode("user_"+ t.getTransactorName()+"-"+t.getTransactor()+"~"+(t.getTransactorId()==null?"":t.getTransactorId())+"="+t.getId(),rootId,t.getTransactorName()+"/"+t.getTransactorSubCompanyName()+"（"+Struts2Utils.getText("workflow.history.entrusted.info")+t.getTrustorName()+"/"+t.getTrustorSubCompanyName()+")", "true", "false", "", "", "user", "");
						}
					}else{
						if(StringUtils.isEmpty(t.getTrustorName())){
							node = new ZTreeNode("user_"+ t.getTransactorName()+"-"+t.getTransactor()+"~"+(t.getTransactorId()==null?"":t.getTransactorId())+"="+t.getId(),rootId,t.getTransactorName(), "true", "false", "", "", "user", "");
						}else{
							node = new ZTreeNode("user_"+ t.getTransactorName()+"-"+t.getTransactor()+"~"+(t.getTransactorId()==null?"":t.getTransactorId())+"="+t.getId(),rootId,t.getTransactorName()+"（"+Struts2Utils.getText("workflow.history.entrusted.info")+t.getTrustorName()+")", "true", "false", "", "", "user", "");
						}
					}
					treeNodes.add(node);
				}
...
//	}	
	 ...
	 * @throws Exception
	 */
	@Action("task-transferTask")
	public String transferTask()throws Exception{
		if(page.getPageSize()>1){
			if(isEnd == null || isEnd.length() == 0){
				taskService.getTransferTasksByActive(page, ContextUtils.getUserId(),false);
			}else{
				taskService.getTransferTasksByActive(page, ContextUtils.getUserId(), Boolean.valueOf(isEnd));
			}
			this.renderText(PageUtils.pageToJson(page));
			return null;
		}
		return "task-transferTask";
	}
	 ...
	 * @throws Exception
	 */
	@Action("task-historyTransferTask")
	public String historyTransferTask()throws Exception{
		if(historyTasks.getPageSize()>1){
			taskService.getHistoryTransferTasksByActive(historyTasks,ContextUtils.getUserId());
			this.renderText(PageUtils.pageToJson(historyTasks));
			return null;
		}
		return "task-historyTransferTask";
	}
...
//	}
	...
	public void setTransactorIdStrs(List<String> transactorIdStrs) {
		this.transactorIdStrs = transactorIdStrs;
	}

	public Page<WorkflowTask> getPage() {
		return page;
	}
	public void setPage(Page<WorkflowTask> page) {
		this.page = page;
	}
