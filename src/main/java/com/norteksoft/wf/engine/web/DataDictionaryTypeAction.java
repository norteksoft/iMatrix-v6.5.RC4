...
public class DataDictionaryTypeAction extends CrudActionSupport<DataDictionaryType>{
	...
	@Override
	@Action("data-dictionary-type-delete")
	public String delete() throws Exception {
		dataDictionaryTypeManager.deleteDictType(dictIds);
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionaryType"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.savedataDictionaryType"), 
				ContextUtils.getSystemId("wf"));
		return list();
	}

	@Override
	@Action("data-dictionary-type-input")
	public String input() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionaryType"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionaryFormpage"), 
				ContextUtils.getSystemId("wf"));
		return "data-dictionary-type-input";
	}
	...
	public String list() throws Exception {
		if(page.getPageSize()>1){
			...
			ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionaryType"), 
					ApiFactory.getBussinessLogService().getI18nLogInfo("wf.dataDictionarytypeList"), 
					ContextUtils.getSystemId("wf"));
	...
	@Override
	@Action("data-dictionary-type-save")
	...
	@Action("data-dictionary-type-validateTypeNo")
