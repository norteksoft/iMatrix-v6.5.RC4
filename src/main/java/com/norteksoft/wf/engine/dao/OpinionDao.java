...
public class OpinionDao extends HibernateDao<Opinion, Long>{
	...
	public List<Opinion> getOpinionsByInstanceId(String workflowId , Long companyId) {
		return find("from Opinion o where o.workflowId=? and o.companyId=? and o.controlId is null order by o.createdTime", workflowId,companyId);
	}
	
	public List<Opinion> getAllOpinionsByInstanceId(String workflowId , Long companyId) {
	...
	public List<Opinion> getOpinionsBytaskId(Long taskId,String loginName) {
		return find("from Opinion o where o.taskId=? and o.creator=? and o.controlId is null order by o.createdTime", taskId,loginName);
	}
	
	public List<Opinion> getOpinionsByWfdId(Long wfdId,String loginName) {
		return find("from Opinion o where o.workflowId=? and o.creator=? and o.controlId is null order by o.createdTime", wfdId,loginName);
	}
	
	
	public List<Opinion> getOpinionsByTaskId(Long taskId , Long companyId) {
		return find("from Opinion o where o.taskId=? and o.companyId=? and o.controlId is null", taskId,companyId);
	}
	...
	public List<Opinion> getOpinions(Long taskId, Long companyId) {
		StringBuilder hql = new StringBuilder("from Opinion o where o.taskId=? and o.companyId=? and o.controlId is null order by o.createdTime");
		return find(hql.toString(), taskId,companyId);
	}	
	
	public List<Opinion> getOpinions(String workflowId, Long companyId,
			String taskName) {
		StringBuilder hql = new StringBuilder("from Opinion o where o.workflowId=? and o.companyId=?  and o.taskName=? and o.controlId is null  order by o.createdTime");
		return find(hql.toString(), workflowId,companyId,taskName);
	}

	public List<Opinion> getOpinions(String workflowId, Long companyId,
			TaskProcessingMode taskMode) {
		StringBuilder hql = new StringBuilder("from Opinion o where o.workflowId=? and o.companyId=?  and o.taskMode=? and o.controlId is null  order by o.createdTime");
	...
	public List<Opinion> getOpinionsExceptCustomField(String workflowId,
			String customField) {
		String hql = "from Opinion d where d.workflowId=? and (d.customField<>? or d.customField is null) and d.controlId is null order by d.createdTime desc";
		return this.find(hql, workflowId,customField);
	}

	public List<Opinion> getOpinionsByCustomField(String workflowId,
			String customField) {
		String hql = "from Opinion d where d.workflowId=? and d.customField=? and d.controlId is null order by d.createdTime desc";
		return this.find(hql, workflowId,customField);
	}
	...
	public List<Object[]> getOpinions(WorkflowTask task){
		String hql = "select t, d from Opinion d, WorkflowTask t  where t.id=d.taskId and d.workflowId=? and d.taskName=? and d.companyId=? and d.opinion is not null and d.controlId is null order by d.taskId desc";
	...
	public List<Opinion> getOpinions(String workflowId, Long companyId,
		...
		StringBuilder hql = new StringBuilder("from Opinion o where o.workflowId=? and o.companyId=? and o.controlId is null");
	...
	public List<Opinion> getOpinionsByTacheCode(String workflowId, Long companyId,
			String tacheCode) {
		StringBuilder hql = new StringBuilder("from Opinion o where o.workflowId=? and o.companyId=?  and o.taskCode=? and o.controlId is null  order by o.createdTime");
	...
	public List<Opinion> getOpinionsByTaskName(String workflowId, Long companyId,
			String  taskName) {
		StringBuilder hql = new StringBuilder("from Opinion o where o.workflowId=? and o.companyId=?  and o.taskName=? and o.taskCode=null and o.controlId is null order by o.createdTime");
		return find(hql.toString(), workflowId,companyId,taskName);
	}
	...
	public void deleteOpinionsByTask(Long companyId, String instanceId, Long taskId){
		createQuery("delete Opinion ih where ih.companyId=? and ih.workflowId=? and ih.taskId=? and ih.controlId is null", 
	...
	public Opinion getOpinion(String instanceId, String controlId,Long companyId) {
		List<Opinion> opinions = find("from Opinion o where o.companyId=? and o.workflowId=? and o.controlId=?", companyId,instanceId,controlId);
	...
	public String getOpinionConclusion(String instanceId, String controlId,Long companyId) {
		List<String> conclusions = find("select o.conclusion from Opinion o where o.companyId=? and o.workflowId=? and o.controlId=?", companyId,instanceId,controlId);
