...
//	private Long tableColumnId;//数据表字段id  
	...
	private String dataSrc;//数据来源,存放数据表名称//在意见控件中表示结论来源值（选项组编号），在意见控件中该值是隐藏在页面中
	private String dataSrcName;//数据来源名称//在意见控件中表示结论来源（选项组名称）
	...
	private String deptShowBranch="false";//是否显示分支
	//计算控件
	...
	private Boolean macroReadonly;//只读
	...
	//意见控件中解析时是否自动显示名称
	private boolean titleVisible=true;//默认为显示
...
//	}
	...
	public Boolean getMacroReadonly() {
		return macroReadonly;
	}
	public void setMacroReadonly(Boolean macroReadonly) {
		this.macroReadonly = macroReadonly;
	}
