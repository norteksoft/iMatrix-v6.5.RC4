...
public class GroupHeaderAction extends CrudActionSupport<GroupHeader>{
	...
	public String delete() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("mms.listViewManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("mms.groupHeaderDelete"), 
	...
	public String list() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("mms.listViewManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("mms.groupHeaderList"), 
				ContextUtils.getSystemId("mms"));
		return "group-header";
	}
	...
	public String save() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("mms.listViewManagement"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("mms.saveGroupHeaderInfo"), 
				ContextUtils.getSystemId("mms"));
