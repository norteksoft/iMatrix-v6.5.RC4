...
public class ListColumnAction extends CrudActionSupport<ListColumn> {
	...
	public String list() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("mms.formManager"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("mms.fieldInfoList"), 
	...
	@Action("list-column-saveColumns")
	...
	@Action("list-column-deleteColumn")
	public String deleteColumn() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("mms.formManager"), 
				ApiFactory.getBussinessLogService().getI18nLogInfo("mms.deleteFieldInfo"), 
				ContextUtils.getSystemId("mms"));
