...
public class publicAction extends CrudActionSupport<Widget> {
	 ...
	 * @throws Exception
	 */
	@Action("public-getStickyNoteVal")
	...
	public String saveStickyNote()throws Exception{
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("portal.portalManagement"), ApiFactory.getBussinessLogService().getI18nLogInfo("portal.saveNote"), ContextUtils.getSystemId("portal"));
		return null;
	}
	 ...
	 * @throws Exception
	 */
	@Action("public-openCountDownWindow")
