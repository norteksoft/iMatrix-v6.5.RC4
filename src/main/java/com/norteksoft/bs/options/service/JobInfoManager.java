...
public class JobInfoManager {
	...
	*/
	...
	public Page<Timer> getCornInfos(Page<Timer> page,Long jobId){
		return this.cornInfoDao.findPage(page,"from Timer c where c.jobId=? and c.companyId=?", jobId,ContextUtils.getCompanyId());
	}
	...
	public Timer getCornInfo(String typeEnum,String corn,String dateTime,String weekTime,String appointTime,String appointSet,Long jobInfoId,String everySecond,String everyHour){
		return cornInfoDao.getCornInfo(typeEnum, corn, dateTime, weekTime, appointTime, appointSet, jobInfoId,everySecond,everyHour);
	}
}
