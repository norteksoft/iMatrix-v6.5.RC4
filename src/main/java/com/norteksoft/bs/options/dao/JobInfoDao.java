...
public class JobInfoDao extends HibernateDao<TimedTask, Long> {
	 ...
	 * @return
	 */
	public List<String>  getTimeTaskByDatasource(Long datasourceId){
		return this.find("select i.code from TimedTask i where i.companyId=? and i.dataSourceId=? ",ContextUtils.getCompanyId(),datasourceId);
	}
}
