...
public class HolidayManager {
	...
	public void saveHoliday(Holiday holiday){
		...
		if(hol!=null){
			...
			hol.setWorkEndTime(holiday.getWorkEndTime());
			hol.setWorkStartTime(holiday.getWorkStartTime());
			holiday = hol;
		}
	...
	public Object[] getWorkHolidaySetting(Long branchId){
		return holidayDao.getWorkHolidaySetting(branchId);
	}
	...
	public List<Date> getHolidays(Long branchId) {
		return holidayDao.getHolidays(branchId);
	}
	/**
	...
	public List<Date> getWorkDates(Long branchId) {
		return holidayDao.getWorkDates(branchId);
	}
	public void updateWorkTime(Long branchId,String workStartTime,String workEndTime){
		holidayDao.updateWorkTime(branchId, workStartTime, workEndTime);
	}
}
