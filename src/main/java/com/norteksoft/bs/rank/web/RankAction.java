...
public class RankAction extends CRUDActionSupport<Superior> {
	...
	public String delete() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("bs.upDownRelationManagement"), ApiFactory.getBussinessLogService().getI18nLogInfo("bs.deleteUdRelation"),ContextUtils.getSystemId("bs"));
		this.renderText("ok");
		return null;
	}
	...
	public String listData() throws Exception {
		if(page.getPageSize()>1){
			...
			ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("bs.upDownRelationManagement"), ApiFactory.getBussinessLogService().getI18nLogInfo("bs.viewUdRelation"),ContextUtils.getSystemId("bs"));
			return null;
		}
		return SUCCESS;
	}
	...
	public String save() throws Exception {
		...
		ApiFactory.getBussinessLogService().log(ApiFactory.getBussinessLogService().getI18nLogInfo("bs.upDownRelationManagement"), ApiFactory.getBussinessLogService().getI18nLogInfo("bs.saveUdRelation"),ContextUtils.getSystemId("bs"));
		return input();
	}
	@Action("user-tree")
