...
<div class="opt-body">
	<div class="opt-btn">
		<button class="btn" onclick="saveFormatSetting();"><span><span>${confirmButton}</span></span></button>
		<button class="btn" onclick='clearAwayFormat();'><span><span >${emptyButton}</span></span></button>
	</div>
	<div id="opt-content">
		<table class="form-table-without-border">
			<tbody>
				<tr>
					<td class="content-title">${formatClassification}</td>
					<td>
						<select id="classify" onchange="selectClassify();">
							<option value="NUMERICAL_VALUE">${formatNumericalValue}</option>
							<option value="CURRENCY">${formatCurrency}</option>
							<option value="DATE">${orderDate}</option>
							<option value="TIME">${formatTime}</option>
							<option value="PERCENT">${formatPercentage}</option>
							<option value="CUSTOM">${formatCustom}</option>
						</select>
					</td>
					<td>
					</td>	
				...
				<tr id="decimalsTr"  style="display: none">
					<td class="content-title">${formatDecimalDigits}</td>
					<td>
				...
				<tr id="thousandSeparateTr"  style="display: none">
					<td class="content-title" style="width: 146px;">${formatUsingThousandSeparator}</td>
					<td>
				...
				<tr id="currencySignTr" style="display: none">
					<td class="content-title">${formatCurrencySymbol}</td>
					<td>
				...
				<tr id="dateTypeTr" style="display: none">
					<td class="content-title">${formatType}</td>
					<td>
						<select id="dateType">
				...
				<tr id="functionNameTr"  style="display: none">
					<td class="content-title">${formatFormat}</td>
					<td>
				...
				<tr id="functionNameEditTr"  style="display: none">
					<td class="content-title">${formatNonFormat}</td>
					<td>
