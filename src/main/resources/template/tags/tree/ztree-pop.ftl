...
<div class="opt-body">
	<div class="cbox-btn">
		...
		<tr>
		<td style="width:80px;">
			<button type='button' class="btn" onclick="_ok_ztree('zTreeId');" id="ok"><span><span>${confirm}</span></span></button>
		</td>
		<td >
			<input id="inputzTreeId" /></td><td ><a class="search-btn" href="#" onclick="ajaxSearch('zTreeId')" ><b class="ui-icon ui-icon-search"></b></a>
		</td>
		</tr>
		</table>
    </div>
