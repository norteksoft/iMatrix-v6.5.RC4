...
<tr>
<td >
	<input id="input${treeId}" /><input id="hiddenText" type="text" style="display:none" /></td><td ><a class="search-btn" href="#" onclick="ajaxSearch('${treeId}')" ><b class="ui-icon ui-icon-search"></b></a>
</td>
</tr>
</table>
<div id="message"></div>
