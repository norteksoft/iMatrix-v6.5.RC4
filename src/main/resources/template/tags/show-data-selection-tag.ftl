...
﻿<html>
	<head>
		...
		<script src="${resourcesCtx}/js/public_${language}.js" type="text/javascript"></script>
		<script src="${resourcesCtx}/widgets/jqgrid/jqgrid_${language}.js" type="text/javascript"></script>
