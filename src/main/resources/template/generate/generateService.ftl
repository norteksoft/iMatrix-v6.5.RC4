...
<#if processFlag?if_exists=="true">
	public void save${entityName}(${entityName} ${lowCaseEntityName},Long taskId){
		save${entityName}(${lowCaseEntityName});
	...
	public String getTaskHander(Long taskId) {
		List<ZTreeNode> treeNodes = generateRemoveSingerTree(taskId);;
