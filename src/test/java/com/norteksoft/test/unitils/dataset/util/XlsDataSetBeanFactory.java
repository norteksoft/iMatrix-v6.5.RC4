package com.norteksoft.test.unitils.dataset.util;
...
import com.norteksoft.bs.sms.service.SmsGatewaySettingManagerTest;
...
public class XlsDataSetBeanFactory {
	...
	private static List<Map<String, Object>> createProps(String file,
		...
		IDataSet expected = new XlsDataSet(SmsGatewaySettingManagerTest.class.getResourceAsStream(file));
